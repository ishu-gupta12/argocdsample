...
public class TaxCalculatorUnitRuleUnit extends AbstractRuleUnit<TaxCalculatorUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @javax.inject.Inject()
    public TaxCalculatorUnitRuleUnit(org.kie.kogito.Application app) {
        super(TaxCalculatorUnit.class.getCanonicalName(), app);
    }

    public com.finobank.pta.taxescalculator.TaxCalculatorUnitRuleUnitInstance internalCreateInstance(TaxCalculatorUnit value) {
        return new com.finobank.pta.taxescalculator.TaxCalculatorUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new com.finobank.pta.taxescalculator.Rules124468C2FDDEC2D953291DFF095CD58B_TaxCalculatorUnit(), ruleBaseConfig);
        return kb;
    }
}
