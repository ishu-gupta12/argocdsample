...
public class SingleNullGLCodeSetterUnitRuleUnit extends AbstractRuleUnit<SingleNullGLCodeSetterUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @javax.inject.Inject()
    public SingleNullGLCodeSetterUnitRuleUnit(org.kie.kogito.Application app) {
        super(SingleNullGLCodeSetterUnit.class.getCanonicalName(), app);
    }

    public com.finobank.pta.setsinglenullGLcode.SingleNullGLCodeSetterUnitRuleUnitInstance internalCreateInstance(SingleNullGLCodeSetterUnit value) {
        return new com.finobank.pta.setsinglenullGLcode.SingleNullGLCodeSetterUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new com.finobank.pta.setsinglenullGLcode.Rules7980478CABA2C3A392A747C896CBF5E1_SingleNullGLCodeSetterUnit(), ruleBaseConfig);
        return kb;
    }
}
