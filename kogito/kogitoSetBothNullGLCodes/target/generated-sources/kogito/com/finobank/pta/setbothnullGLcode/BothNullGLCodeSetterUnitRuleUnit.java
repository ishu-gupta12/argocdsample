...
public class BothNullGLCodeSetterUnitRuleUnit extends AbstractRuleUnit<BothNullGLCodeSetterUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @javax.inject.Inject()
    public BothNullGLCodeSetterUnitRuleUnit(org.kie.kogito.Application app) {
        super(BothNullGLCodeSetterUnit.class.getCanonicalName(), app);
    }

    public com.finobank.pta.setbothnullGLcode.BothNullGLCodeSetterUnitRuleUnitInstance internalCreateInstance(BothNullGLCodeSetterUnit value) {
        return new com.finobank.pta.setbothnullGLcode.BothNullGLCodeSetterUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new com.finobank.pta.setbothnullGLcode.RulesF08758C3B0C48D1A8FEEB907D51082A5_BothNullGLCodeSetterUnit(), ruleBaseConfig);
        return kb;
    }
}
