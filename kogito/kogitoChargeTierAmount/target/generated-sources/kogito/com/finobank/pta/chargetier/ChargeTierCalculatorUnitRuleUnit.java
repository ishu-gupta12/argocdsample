...
public class ChargeTierCalculatorUnitRuleUnit extends AbstractRuleUnit<ChargeTierCalculatorUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @javax.inject.Inject()
    public ChargeTierCalculatorUnitRuleUnit(org.kie.kogito.Application app) {
        super(ChargeTierCalculatorUnit.class.getCanonicalName(), app);
    }

    public com.finobank.pta.chargetier.ChargeTierCalculatorUnitRuleUnitInstance internalCreateInstance(ChargeTierCalculatorUnit value) {
        return new com.finobank.pta.chargetier.ChargeTierCalculatorUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new com.finobank.pta.chargetier.Rules72E9FCBA65B08233BFEA940168E38FFB_ChargeTierCalculatorUnit(), ruleBaseConfig);
        return kb;
    }
}
