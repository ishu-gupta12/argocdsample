...
public class CheckAllowedTransactionUnitRuleUnit extends AbstractRuleUnit<CheckAllowedTransactionUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @javax.inject.Inject()
    public CheckAllowedTransactionUnitRuleUnit(org.kie.kogito.Application app) {
        super(CheckAllowedTransactionUnit.class.getCanonicalName(), app);
    }

    public com.finobank.pta.allowedtransaction.CheckAllowedTransactionUnitRuleUnitInstance internalCreateInstance(CheckAllowedTransactionUnit value) {
        return new com.finobank.pta.allowedtransaction.CheckAllowedTransactionUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new com.finobank.pta.allowedtransaction.RulesFB20537E64034E3BED15CADAABACC7D4_CheckAllowedTransactionUnit(), ruleBaseConfig);
        return kb;
    }
}
