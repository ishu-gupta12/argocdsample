...
public class ChargeAccountCalculatorUnitRuleUnit extends AbstractRuleUnit<ChargeAccountCalculatorUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @javax.inject.Inject()
    public ChargeAccountCalculatorUnitRuleUnit(org.kie.kogito.Application app) {
        super(ChargeAccountCalculatorUnit.class.getCanonicalName(), app);
    }

    public com.finobank.pta.chargeaccount.ChargeAccountCalculatorUnitRuleUnitInstance internalCreateInstance(ChargeAccountCalculatorUnit value) {
        return new com.finobank.pta.chargeaccount.ChargeAccountCalculatorUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new com.finobank.pta.chargeaccount.RulesC7DF8C050BB15943859DD690572C5AE9_ChargeAccountCalculatorUnit(), ruleBaseConfig);
        return kb;
    }
}
